            ...
            <div id="c2" class="card shadow-md mb-6">
                <div class="card-body">
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form method="POST" action="{{ route('owner.productcategories.store')}}">
                                    @csrf
                                                        ...
                                                        aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="POST" action="{{ route('owner.productcategories.update', $category -> id) }}">
                                                                    @csrf
                                                                    @method('PATCH')
                                                        ...
                                                        <!--Delete Account-->
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('owner.productcategories.destroy', $category -> id) }}" method="post">
                                                                            @csrf
                                                                            @method('DELETE')

                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-center">
                                                                <button type="button" style="margin: 0%" class="far fa-edit btn btn-yellow btn-md" data-toggle="modal" data-category="{{$category -> category_name}}" data-id="{{$category -> id}}" data-target="#modalCategoryEdit" style="font-size: 1rem;"></button>
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body mx-3">
                                                                        ...
                                                                        <div class="form-group md-form ml-0 mr-0">
                                                                                ...
                                                                                <input id="cat_edit" type="text" class="form-control" name="category_name" value="{{$category -> category_name}}" required>

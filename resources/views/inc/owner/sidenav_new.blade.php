            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/owner/salesummary" class="nav-link">
                      <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
                      <p>Sales summary</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/owner/salesbyproduct" class="nav-link">
                      <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
              ...
              <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="/owner/productcategories" class="nav-link ">
                          <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
              ...
              <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="/owner/item_list" class="nav-link">
                          <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
                          <p>Item list</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="/owner/categories" class="nav-link ">
                          <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
                          <p>Item Categories</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="/owner/stockadjustment" class="nav-link ">
                          <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
                          <p>Stock History</p>
                        </a>
                      </li>
                      ...
                      <li class="nav-item">
                        <a href="/owner/critical_stock" class="nav-link">
                          <i class="fa fa-circle-o nav-icon" style="visibility: hidden;"></i>
                          <p>Critical Stock</p>
                        </a>
                      </li>
                  ...
                  <!-- accoutns -->
              <li class="nav-item">
                <a href="/owner/accounts" class="nav-link">
